...
from rbac.rbac_forms import MenuForm, PermissionForm, MultiPermissionForm, RoleForm
...
def menu_list(request):
    ...
    for i in all_permission.values('id', 'title', 'url', 'name', 'menu_id', 'menu__title', 'parent_id'):
...
def delete(request, obj, pk):
    ...
    if obj == 'permission':
        return redirect('menu_list')
    return redirect('{}_list'.format(obj))
